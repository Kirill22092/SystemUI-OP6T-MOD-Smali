...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .line 66
    iput-object p4, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mTimeColorStates:[I

    new-array p4, p3, [I

    .line 67
    iput-object p4, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mTimeLabelColorStates:[I

    .line 195
    new-instance p4, Lcom/oneplus/lib/widget/TextInputTimePickerView$5;

    invoke-direct {p4, p0}, Lcom/oneplus/lib/widget/TextInputTimePickerView$5;-><init>(Lcom/oneplus/lib/widget/TextInputTimePickerView;)V

    iput-object p4, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mClickListener:Landroid/view/View$OnClickListener;
    ...
    sget v0, Lcom/oneplus/commonctrl/R$layout;->time_picker_text_input_material:I
    ...
    .line 89
    sget p4, Lcom/oneplus/commonctrl/R$id;->input_am_pm_parent:I
    ...
    .line 90
    sget p4, Lcom/oneplus/commonctrl/R$id;->input_block:I
    ...
    .line 91
    sget p4, Lcom/oneplus/commonctrl/R$id;->input_hour:I
    ...
    .line 92
    sget p4, Lcom/oneplus/commonctrl/R$id;->input_minute:I
    ...
    .line 96
    sget p4, Lcom/oneplus/commonctrl/R$id;->top_label:I
    ...
    .line 97
    sget p4, Lcom/oneplus/commonctrl/R$id;->label_error:I
    ...
    .line 98
    sget p4, Lcom/oneplus/commonctrl/R$id;->label_hour:I
    ...
    .line 99
    sget p4, Lcom/oneplus/commonctrl/R$id;->label_minute:I
    ...
    iput-object p4, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mMinuteLabel:Landroid/widget/TextView;

    new-array p4, p3, [I

    .line 100
    sget v0, Lcom/oneplus/commonctrl/R$attr;->opPickerColorActivated:I

    const/4 v2, 0x0

    aput v0, p4, v2

    sget v0, Lcom/oneplus/commonctrl/R$attr;->opPickerColorUnActivated:I
    ...
    .line 101
    sget v0, Lcom/oneplus/commonctrl/R$attr;->opPickerInputLabelUnActivated:I
    ...
    sget v3, Lcom/oneplus/commonctrl/R$integer;->oneplus_contorl_time_part6:I

    invoke-virtual {v0, v3}, Landroid/content/res/Resources;->getInteger(I)I

    move-result v0

    iput v0, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mLabelAlphaDuration:I
    ...
    .line 108
    iget-object p3, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mTimeLabelColorStates:[I
    ...
    .line 111
    iget-object p2, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mHourEditText:Landroid/widget/EditText;

    new-instance p3, Lcom/oneplus/lib/widget/TextInputTimePickerView$1;

    invoke-direct {p3, p0}, Lcom/oneplus/lib/widget/TextInputTimePickerView$1;-><init>(Lcom/oneplus/lib/widget/TextInputTimePickerView;)V

    invoke-virtual {p2, p3}, Landroid/widget/EditText;->setOnFocusChangeListener(Landroid/view/View$OnFocusChangeListener;)V

    .line 126
    iget-object p2, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mMinuteEditText:Landroid/widget/EditText;

    new-instance p3, Lcom/oneplus/lib/widget/TextInputTimePickerView$2;

    invoke-direct {p3, p0}, Lcom/oneplus/lib/widget/TextInputTimePickerView$2;-><init>(Lcom/oneplus/lib/widget/TextInputTimePickerView;)V
    ...
    new-instance p3, Lcom/oneplus/lib/widget/TextInputTimePickerView$3;

    invoke-direct {p3, p0}, Lcom/oneplus/lib/widget/TextInputTimePickerView$3;-><init>(Lcom/oneplus/lib/widget/TextInputTimePickerView;)V
    ...
    new-instance p3, Lcom/oneplus/lib/widget/TextInputTimePickerView$4;

    invoke-direct {p3, p0}, Lcom/oneplus/lib/widget/TextInputTimePickerView$4;-><init>(Lcom/oneplus/lib/widget/TextInputTimePickerView;)V
    ...
    .line 170
    sget p2, Lcom/oneplus/commonctrl/R$id;->am_pm_group:I
    ...
    iput-object p2, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mAmPmGroup:Landroid/widget/RadioGroup;

    .line 171
    sget p2, Lcom/oneplus/commonctrl/R$id;->am_label2:I
    ...
    iput-object p2, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mAmLabel:Landroid/widget/RadioButton;

    .line 172
    iget-object p2, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mAmLabel:Landroid/widget/RadioButton;

    aget-object p3, p1, v2

    invoke-static {p3}, Lcom/oneplus/lib/widget/TimePickerClockDelegate;->obtainVerbatim(Ljava/lang/String;)Ljava/lang/CharSequence;
    ...
    iget-object p3, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mClickListener:Landroid/view/View$OnClickListener;
    ...
    invoke-static {p2}, Lcom/oneplus/lib/widget/TextInputTimePickerView;->ensureMinimumTextWidth(Landroid/widget/TextView;)V

    .line 176
    sget p2, Lcom/oneplus/commonctrl/R$id;->pm_label2:I
    ...
    iput-object p2, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mPmLabel:Landroid/widget/RadioButton;

    .line 177
    iget-object p2, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mPmLabel:Landroid/widget/RadioButton;

    aget-object p1, p1, v1

    invoke-static {p1}, Lcom/oneplus/lib/widget/TimePickerClockDelegate;->obtainVerbatim(Ljava/lang/String;)Ljava/lang/CharSequence;
    ...
    .line 178
    iget-object p1, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mPmLabel:Landroid/widget/RadioButton;

    iget-object p2, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mClickListener:Landroid/view/View$OnClickListener;

    invoke-virtual {p1, p2}, Landroid/widget/RadioButton;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 179
    iget-object p0, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mPmLabel:Landroid/widget/RadioButton;

    invoke-static {p0}, Lcom/oneplus/lib/widget/TextInputTimePickerView;->ensureMinimumTextWidth(Landroid/widget/TextView;)V
...
.method static synthetic access$000(Lcom/oneplus/lib/widget/TextInputTimePickerView;)Landroid/widget/EditText;
    ...
    .line 38
    iget-object p0, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mHourEditText:Landroid/widget/EditText;
...
.method static synthetic access$100(Lcom/oneplus/lib/widget/TextInputTimePickerView;)Landroid/widget/EditText;
    ...
    .line 38
    iget-object p0, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mMinuteEditText:Landroid/widget/EditText;
...
.method static synthetic access$300(Lcom/oneplus/lib/widget/TextInputTimePickerView;)[I
    ...
    .line 38
    iget-object p0, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mTimeColorStates:[I
...
.method static synthetic access$800(Lcom/oneplus/lib/widget/TextInputTimePickerView;)Lcom/oneplus/lib/widget/TextInputTimePickerView$OnValueTypedListener;
    ...
    .line 38
    iget-object p0, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mListener:Lcom/oneplus/lib/widget/TextInputTimePickerView$OnValueTypedListener;
...
.method private getHourOfDayFromLocalizedHour(I)I
    ...
    .line 398
    iget-boolean p0, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mHourFormatStartsAtZero:Z
...
.method private isValidLocalizedHour(I)Z
    ...
    .line 391
    iget-boolean p0, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mIs24Hour:Z
...
.method private parseAndSetHourInternal(Ljava/lang/String;)Z
    ...
    .line 359
    invoke-direct {p0, p1}, Lcom/oneplus/lib/widget/TextInputTimePickerView;->isValidLocalizedHour(I)Z
    ...
    .line 362
    :goto_0
    iget-object v3, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mListener:Lcom/oneplus/lib/widget/TextInputTimePickerView$OnValueTypedListener;

    .line 363
    invoke-static {p1, v2, v1}, Lcom/oneplus/lib/util/MathUtils;->constrain(III)I

    move-result p1

    .line 362
    invoke-direct {p0, p1}, Lcom/oneplus/lib/widget/TextInputTimePickerView;->getHourOfDayFromLocalizedHour(I)I

    move-result p0

    invoke-interface {v3, v0, p0}, Lcom/oneplus/lib/widget/TextInputTimePickerView$OnValueTypedListener;->onValueChanged(II)V

    return v0

    .line 366
    :cond_2
    iget-object v1, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mListener:Lcom/oneplus/lib/widget/TextInputTimePickerView$OnValueTypedListener;

    invoke-direct {p0, p1}, Lcom/oneplus/lib/widget/TextInputTimePickerView;->getHourOfDayFromLocalizedHour(I)I

    move-result p0

    invoke-interface {v1, v0, p0}, Lcom/oneplus/lib/widget/TextInputTimePickerView$OnValueTypedListener;->onValueChanged(II)V
    :try_end_0
...
.method private parseAndSetMinuteInternal(Ljava/lang/String;)Z
    ...
    invoke-interface {p0, v2, p1}, Lcom/oneplus/lib/widget/TextInputTimePickerView$OnValueTypedListener;->onValueChanged(II)V
...
.method private resetInputTimeLabelState(Z)V
    ...
    iget-object p0, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mTimeLabelColorStates:[I
...
.method private setError(Z)V
    ...
    .line 328
    iget-object p0, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mMinuteLabel:Landroid/widget/TextView;
...
.method public getInputBlock()Landroid/view/View;
    ...
    .line 211
    iget-object p0, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mInputBlock:Landroid/view/View;
...
.method public setAmPmAtStart(Z)V
    ...
    .line 265
    iget-object p1, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mAmPmParent:Landroid/widget/LinearLayout;

    iget-object p0, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mAmPmGroup:Landroid/widget/RadioGroup;
    ...
    .line 279
    :goto_0
    iget-object p0, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mAmPmParent:Landroid/widget/LinearLayout;
...
.method public showLabels(Z)V
    ...
    .line 230
    iget-object p1, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mHourLabel:Landroid/widget/TextView;
    ...
    .line 233
    iget-object p1, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mMinuteLabel:Landroid/widget/TextView;
    ...
    .line 236
    iget-object p1, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mHeaderLabel:Landroid/widget/TextView;
    ...
    iget p0, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mLabelAlphaDuration:I
    ...
    sget-object p1, Lcom/oneplus/lib/util/AnimatorUtils;->FastOutSlowInInterpolator:Landroid/view/animation/Interpolator;
...
.method updateTextInputValues(IIIZZ)V
    ...
    .line 344
    iget-object p5, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mAmPmGroup:Landroid/widget/RadioGroup;
    ...
    .line 345
    :goto_1
    invoke-direct {p0, p3}, Lcom/oneplus/lib/widget/TextInputTimePickerView;->updateAmPmLabel(Z)V

    .line 346
    iget-object p3, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mHourEditText:Landroid/widget/EditText;
    ...
    .line 347
    iget-object p3, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mMinuteEditText:Landroid/widget/EditText;
    ...
    .line 348
    iget-object p1, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mHourEditText:Landroid/widget/EditText;
    ...
    .line 349
    iget-object p1, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mMinuteEditText:Landroid/widget/EditText;
    ...
    .line 351
    iget-boolean p1, p0, Lcom/oneplus/lib/widget/TextInputTimePickerView;->mErrorShowing:Z
