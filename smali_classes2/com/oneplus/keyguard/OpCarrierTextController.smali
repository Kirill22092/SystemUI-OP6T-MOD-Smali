...
.method protected opGetCarrierName(ILjava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    sget p1, Lcom/android/systemui/R$string;->sim_status_uss_network_roam:I
...
.method protected opGetCustomizeCarrierName(Ljava/lang/CharSequence;Landroid/telephony/SubscriptionInfo;)Ljava/lang/String;
    ...
    invoke-direct {p0, p2}, Lcom/oneplus/keyguard/OpCarrierTextController;->getNetworkType(I)I

    iget-object p2, p0, Lcom/oneplus/keyguard/OpCarrierTextController;->mFiveGServiceClient:Lcom/android/systemui/statusbar/policy/FiveGServiceClient;

    if-nez p2, :cond_0

    iget-object p2, p0, Lcom/oneplus/keyguard/OpCarrierTextController;->mContext:Landroid/content/Context;

    invoke-static {p2}, Lcom/android/systemui/statusbar/policy/FiveGServiceClient;->getInstance(Landroid/content/Context;)Lcom/android/systemui/statusbar/policy/FiveGServiceClient;

    move-result-object p2

    iput-object p2, p0, Lcom/oneplus/keyguard/OpCarrierTextController;->mFiveGServiceClient:Lcom/android/systemui/statusbar/policy/FiveGServiceClient;
    ...
    invoke-virtual {p2, v1}, Lcom/android/systemui/statusbar/policy/FiveGServiceClient;->registerCallback(Lcom/android/keyguard/KeyguardUpdateMonitorCallback;)V
