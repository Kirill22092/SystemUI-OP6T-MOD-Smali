...
.method private addBluetoothDevices(Ljava/util/List;)V
    ...
    invoke-static {v5, v7}, Lcom/android/internal/util/ArrayUtils;->contains([Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method private synthetic lambda$onCreate$0()Lcom/android/settingslib/bluetooth/LocalBluetoothManager;
    .locals 0
...
# virtual methods
.method public backToVolumeDialog()V
    .locals 1

    invoke-virtual {p0}, Lcom/oneplus/volume/OpOutputChooserDialog;->dismiss()V

    iget-object p0, p0, Lcom/oneplus/volume/OpOutputChooserDialog;->mController:Lcom/android/systemui/plugins/VolumeDialogController;

    if-eqz p0, :cond_0

    const/4 v0, 0x4

    invoke-interface {p0, v0}, Lcom/android/systemui/plugins/VolumeDialogController;->showVolumeDialog(I)V
...
.method protected findActiveDevice(I)Landroid/bluetooth/BluetoothDevice;
    ...
    invoke-virtual {p0, v1, v2}, Lcom/oneplus/volume/OpOutputChooserDialog;->isStreamFromOutputDevice(ILjava/util/Set;)Z
    ...
    const-string v0, "StreamFrom output DEVICE_OUT_ALL_A2DP_SET:"
    ...
    invoke-virtual {p0, v2, v1}, Lcom/oneplus/volume/OpOutputChooserDialog;->isStreamFromOutputDevice(ILjava/util/Set;)Z
...
.method public isStreamFromOutputDevice(ILjava/util/Set;)Z
    ...
    invoke-virtual {p0, p1, v0}, Lcom/oneplus/volume/OpOutputChooserDialog;->isStreamFromOutputDevice(II)Z
...
.method public synthetic lambda$dismiss$3$OpOutputChooserDialog()V
    ...
    invoke-direct {p0}, Lcom/oneplus/volume/OpOutputChooserDialog;->lambda$dismiss$3()V
...
.method public synthetic lambda$onCreate$0$OpOutputChooserDialog()Lcom/android/settingslib/bluetooth/LocalBluetoothManager;
    ...
    invoke-direct {p0}, Lcom/oneplus/volume/OpOutputChooserDialog;->lambda$onCreate$0()Lcom/android/settingslib/bluetooth/LocalBluetoothManager;
...
.method public synthetic lambda$onCreate$1$OpOutputChooserDialog()V
    ...
    invoke-direct {p0}, Lcom/oneplus/volume/OpOutputChooserDialog;->lambda$onCreate$1()V
...
.method public synthetic lambda$show$2$OpOutputChooserDialog()V
    ...
    invoke-direct {p0}, Lcom/oneplus/volume/OpOutputChooserDialog;->lambda$show$2()V
...
.method public onAttachedToWindow()V
    ...
    iget-object p0, p0, Lcom/oneplus/volume/OpOutputChooserDialog;->mBluetoothCallbackHandler:Lcom/oneplus/volume/OpOutputChooserDialog$BluetoothCallbackHandler;
...
.method public setTheme(I)V
    ...
    iget v0, p0, Lcom/oneplus/volume/OpOutputChooserDialog;->mIconColor:I

    invoke-virtual {p1, v0}, Lcom/oneplus/volume/OpOutputChooserLayout;->setBackKeyColor(I)V
